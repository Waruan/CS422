...

{
  ...
  PImage but0 = loadImage("pin0.png");
  
  PImage but1 = loadImage("pin1.png");

  PImage but2 = loadImage("pin2.png");

  PImage but3 = loadImage("pin3.png");
  
  PImage but4 = loadImage("pin4.png");
  
  PImage but5 = loadImage("pin5.png");
  
  PImage but6 = loadImage("pin6.png");
  
  PImage but7 = loadImage("pin7.png");
  
  PImage but8 = loadImage("pin8.png");
  
  PImage but9 = loadImage("pin9.png");
  
  PImage butpinBack = loadImage("pinback.png");
  
  PImage butpinOk = loadImage("pinok.png");
  
  PImage butpin0Changed = loadImage("pin0changed.gif");
  
  PImage butpin1Changed = loadImage("pin1changed.gif");
  
  PImage butpin2Changed = loadImage("pin2changed.gif");
  
  PImage butpin3Changed = loadImage("pin3changed.gif");
  
  PImage butpin4Changed = loadImage("pin4changed.gif");
  
  PImage butpin5Changed = loadImage("pin5changed.gif");
  
  PImage butpin6Changed = loadImage("pin6changed.gif");
  
  PImage butpin7Changed = loadImage("pin7changed.gif");
  
  PImage butpin8Changed = loadImage("pin8changed.gif");
  
  PImage butpin9Changed = loadImage("pin9changed.gif");
  
  PImage butpinbackChanged = loadImage("pinbackchanged.gif");
  
  PImage butpinokChanged = loadImage("pinokchanged.gif");
