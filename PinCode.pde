...

{
  ...
  int y0 = (int)canvasHeight/4+buttonSize+220;
  
  int y = (int)canvasHeight/4+buttonSize+100;
  
  int y2 = (int)canvasHeight/4+buttonSize+100;
  
  int y3 = (int)canvasHeight/4+buttonSize+100;
  
  int y4 = (int)canvasHeight/4+buttonSize+140;
  
  int y5 = (int)canvasHeight/4+buttonSize+140;
  
  int y6 = (int)canvasHeight/4+buttonSize+140;
  
  int y7 = (int)canvasHeight/4+buttonSize+180;
  
  int y8 = (int)canvasHeight/4+buttonSize+180;
  
  int y9 = (int)canvasHeight/4+buttonSize+180;
  
  int y10 = (int)canvasHeight/4+buttonSize+220;
  
  int y11 = (int)canvasHeight/4+buttonSize+220;
  ...
  textSize(20);
  fill(102);
  rect((int)canvasWidth/4 + 300,(int)canvasHeight/3 + 60,95,40);
  fill(0);
  text("Please Enter Pin:", (int)canvasWidth/4 + 270, (int)canvasHeight/3 + 40);
...

  {
    ...
    if(pressed) {
      ...
      {  
        ...
        textSize(40);
        fill(102);
        text("*", (int)canvasWidth/4 + 315 + pinSpace, (int)canvasHeight/3 + 100);
